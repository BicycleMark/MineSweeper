...
namespace MineSweeper.Views.Controls
{
    ...
    public class GridAnimationManager
    {
        ...
        public void SelectRandomAnimationStyle()
        {
            ...
            System.Diagnostics.Debug.WriteLine($"Grid animation style: {_currentAnimationType}, Pattern: {_currentPattern}");
        }
        ...
        private void HandleGetCellImage(object? sender, GetCellImageEventArgs args)
        {
            ...
            Application.Current?.Dispatcher.Dispatch(async () => {
                ...
                int delay = GridAnimationExtensions.CalculateAnimationDelay(
                    args.Row, 
                    args.Column, 
                    _currentPattern, 
                    _grid.Rows, 
