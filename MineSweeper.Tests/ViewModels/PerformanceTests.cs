...
public class PerformanceTests
{
    ...
    public async Task NewGame_ShouldCreateGameWithinTimeLimit(string difficultyName, int maxAllowedTimeMs)
    {
        ...
        for (var i = 0; i < iterations; i++)
        {
            ...
            if (_viewModel.Items != null) _viewModel.Items.CollectionChanged += (s, e) => _propertyChangeCount++;
        ...
        Console.WriteLine(
            $"Creating {difficultyName} game took an average of {averageElapsedMs}ms over {iterations} iterations");
